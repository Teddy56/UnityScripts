...
public class Mobile_Smilzo_Controller : MonoBehaviour {
	...
	void charactorMove(){
		...
		if (CrossPlatformInputManager.GetAxisRaw ("Horizontal") != 0 || CrossPlatformInputManager.GetAxisRaw ("Vertical") != 0) {
			...
			Vector3 moveDirect = cameraForward * CrossPlatformInputManager.GetAxisRaw ("Vertical") * speed + Camera.main.transform.right * CrossPlatformInputManager.GetAxisRaw ("Horizontal") * speed;
	...
	void charactorTurn(){
		...
		Vector3 direction = Vector3.Scale (Camera.main.transform.forward, new Vector3 (1, 0, 1)).normalized * CrossPlatformInputManager.GetAxisRaw ("Vertical") + Camera.main.transform.right * CrossPlatformInputManager.GetAxisRaw ("Horizontal");
